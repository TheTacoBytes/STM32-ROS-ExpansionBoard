...
class Rosmaster(object):
    ...
    # Read the default angle of the front wheel servo of an Ackermann-type (R2) car.
    ...
    # Obtain the three-axis data from the magnetometer, returning m_x, m_y, m_z.
    def get_magnetometer_data(self):
        m_x, m_y, m_z = self.__mx, self.__my, self.__mz
        # self.__mx, self.__my, self.__mz = 0.0, 0.0, 0.0
        return m_x, m_y, m_z

    # Obtain the attitude angles of the board, returning yaw, roll, and pitch
    # If ToAngle=True, return values in degrees; if ToAngle=False, return values in radians
...
if __name__ == '__main__':
    # Low-level processing library for the car
    import platform
